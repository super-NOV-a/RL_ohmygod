...
from train_test.gym_pybullet_drones.envs.HoverAviary import HoverAviary
from train_test.gym_pybullet_drones.envs.MultiHoverAviary import MultiHoverAviary
...
def run(multiagent=DEFAULT_MA, output_folder=DEFAULT_OUTPUT_FOLDER, gui=DEFAULT_GUI, plot=True, colab=DEFAULT_COLAB,
    ...
    if DEFAULT_ACT == ActionType.ONE_D_RPM:
        target_reward = 474.15 if not multiagent else 929.5
    else:
