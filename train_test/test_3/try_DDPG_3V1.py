...
import numpy as np
import argparse
from train_test.utils.ddpg import DDPG
import copy
...
Env_name = 'c3v1ddpg'  # c3v1\c3v1a\c3v1p  # MADDPG训练的模型
Mark = 9201  # todo 测试时指定mark MADDPG C3V1A 最好的是7005
action = 'vel'
...
Success_KeepDistance = 0.4      # 彼此不碰撞距离。不碰撞距离 成功条件
...
class Runner:
    def __init__(self, args):
        ...
        self.number = 3  #
        self.seed = 11451  # 保证一个seed，名称使用记号--mark
...
if __name__ == '__main__':
    ...
    parser.add_argument("--algorithm", type=str, default="DDPG", help="MADDPG or MATD3")
