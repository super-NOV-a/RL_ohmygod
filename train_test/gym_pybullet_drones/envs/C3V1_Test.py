import numpy as np
from train_test.gym_pybullet_drones.envs.C3V1RL_Test import C3V1RL_Test
...
class C3V1_Test(C3V1RL_Test):
    ...
    def __init__(self,
        ...
        self.follow_distance = follow_distance/5    # 环境到真实距离的映射
        self.acctack_distance = acctack_distance/5
        self.keep_distance = keep_distance/5
